...
# Menu bar
    ...
    def msg(self):
        tkinter.messagebox.showinfo("HellO Myself Logistic PyBOT v2.8",' Please ask me your questions about products and srvices !!')

    def about(self):
        tkinter.messagebox.showinfo("Logistic PyBOT Developers","1.Jitesh Gharat\n2.Sahil Bambarde\n3.Rushikesh Bunge")
